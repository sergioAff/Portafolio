...
export const experiencias: Experience[] = [
  {
    ...
    descripcion:
      "Desarrollo de aplicaciones web utilizando JavaScript y React, creación de aplicaciones de escritorio con Python, y gestión de bases de datos en SQLite y PostgreSQL. Trabajo enfocado en entregar soluciones personalizadas que cumplen con los requisitos específicos de los clientes, asegurando alta calidad y cumplimiento de plazos.",
    lugar: "Remoto",
    preview:
      "Desarrollo de aplicaciones web y de escritorio utilizando tecnologías modernas...",
  ...
  },
  {
    ...
    lugar: "Remoto",
    preview: "Desarrollo de software y colaboración en proyectos en Python...",
