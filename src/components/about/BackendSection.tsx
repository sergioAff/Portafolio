      ...
      body={
        <ul className="flex flex-wrap gap-6 lg:gap-8 items-center justify-around px-5 py-1">
          ...
          <li className="flex flex-col items-center  ">
            <SiDjango className="w-10 2xl:w-12 h-auto" color="#0f6117" />{" "}
            <p className=" text-sm 2xl:text-lg font-semibold text-gray-800">
              Django
            </p>
          </li>
          ...
          <li className="flex flex-col items-center  ">
            <SiSpringboot className="w-10 2xl:w-12 h-auto" color="#6DB33F" />{" "}
            <p className=" text-sm 2xl:text-lg font-semibold text-gray-800">
              Spring
            </p>
          </li>
          <li className="flex flex-col items-center  ">
            <SiPostgresql className="w-10 2xl:w-12 h-auto" color="#336791" />{" "}
            <p className=" text-sm 2xl:text-lg font-semibold text-gray-800">
              PostgreSQL
            </p>
          </li>
