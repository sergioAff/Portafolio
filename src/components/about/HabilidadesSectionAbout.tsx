          ...
          <ul className="flex flex-col gap-2">
            {habilidadesBlandas.map((habilidad, index) => (
              <li key={index} className="flex items-center">
                ...
                <Link
                  className="ml-3 cursor-pointer text-base text-gray-700 font-semibold lg:text-lg overflow-hidden transition-all ease-in-out duration-200 hover:text-orange-500"
