...
export const ModalDescription = ({
  ...
  return (
    <motion.div
      className="absolute self-start flex flex-col gap-3 max-h-[40dvh] inset-0 z-50 bg-claro ring ring-orange-500 w-[80dvw] md:w-[70dvw] lg:w-[50dvw] mx-auto px-3 py-4 rounded-lg"
